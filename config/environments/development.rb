AlfredMueller::Application.configure do
  ...
  # NOTE: Don't use config.threadsafe! ... have a look at it's implementation.
  # NOTE: PS: My changes weren't loaded in development mode if threadsafe is set
  # config.threadsafe!
