...
SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item :reference_projects, 'Referenzprojekte', cms_reference_projects_path, :highlights_on => :subpath
    primary.item :gallery_photos, 'Fotogalerie', cms_gallery_photos_path, :highlights_on => :subpath
