class window.AlfredMueller.Routers.Application extends Backbone.Router
  ...
  initialize: ->
    ...
    $("
      .reference-projects-slider       .flexslider,
      .reference-project-images-slider .flexslider,
      .services-slides-container       .flexslider,
      .job-profile-slides-container    .flexslider,
      .gallery-photos-slider           .flexslider
      ").flexslider(
      directionNav: true,
      controlNav: false,
      slideshow: false,
