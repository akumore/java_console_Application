...
describe "Cms::Descriptions" do
  ...
  describe '#new' do
    before :each do
      ...
      # TODO flavio, noelle: remove spec a soon as additional_description isn't needed anymore
      # click_on 'Beschreibungen'
    end

    pending 'remove this spec as soon as all fields from additional_description are moved to other models, and also specs are moved (see Feature 24/21)'
